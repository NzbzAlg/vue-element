  ...
  <div class="supplier">
    ...
    <div class="title">
      <div class="title_left">
        <el-select v-model="value" placeholder="请选择部门查询">
          <el-option v-for="item in state" :key="item.id" :label="item.label" :value="item"></el-option>
        </el-select>
        <el-input placeholder="请输入供应商查询" style="width:210px;margin-left:20px"></el-input>
        <el-button type="primary" style="margin-left:20px">查询</el-button>
      </div>
      <div class="title_right">
        <el-button type="primary" @click="addSupplierPop">添加供应商</el-button>
      </div>
    </div>
    <!-- 表格 -->
    <div class="content">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="date" label="所属部门" align="center"></el-table-column>
        <el-table-column prop="name" label="供应商" align="center"></el-table-column>
        <el-table-column prop="address" label="简拼" align="center"></el-table-column>
        ...
        <el-table-column prop="address" label="收款账号" align="center"></el-table-column>
    ...
    <!-- 弹窗 -->
    <el-dialog title="编辑供应商" :visible.sync="dialogVisible" width="35%">
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="地址：">
              <el-input style="width:525px"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="所属部门：">
              <el-select v-model="value" placeholder="请选择店铺查询" style="width:525px">
                <el-option v-for="item in state" :key="item.id" :label="item.label" :value="item"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
