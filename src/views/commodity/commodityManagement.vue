  ...
  <div class="productsDepartment">
    ...
    <div class="title">
      <div class="title_left">
        ...
        <el-select v-model="value" placeholder="请选择类别查询" style="margin-left:20px">
          <el-option v-for="item in state" :key="item.id" :label="item.label" :value="item"></el-option>
        </el-select>
      ...
      <div class="title_right">
        ...
        <el-button type="primary">添加组合商品</el-button>
      </div>
    </div>
    <!-- 表格 -->
    <div class="content">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="address" label="类别" align="center"></el-table-column>
        ...
        <el-table-column label="操作" align="center" width="380">
          <template>
            ...
            <el-button size="mini" type="primary">调到辅料</el-button>
    ...
    <el-dialog title="提示" :visible.sync="productUpdate" width="60%">
      <div class="productUpdate_top">
        ...
        <div class="pUpdate_size">
          ...
          <el-input placeholder="请输入内容" v-model="input2" style="width:300px;margin-left:40px">
            <template slot="prepend">选择类别</template>
          </el-input>
          <el-input placeholder="请输入内容" v-model="input2" style="width:640px;margin-top:15px">
            <template slot="prepend">子类sku</template>
          </el-input>
          <el-input placeholder="请输入内容" v-model="input2" style="width:640px;margin-top:15px">
            <template slot="prepend">辅料名称</template>
          </el-input>
          <el-input placeholder="请输入内容" v-model="input2" style="width:640px;margin-top:15px">
            <template slot="prepend">辅料sku</template>
          </el-input>
        </div>
      </div>
      <div class="productUpdate_bottom">
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          <el-tab-pane label="基本" name="first">
            ...
            <el-input placeholder="请输入内容" v-model="input2" style="width:300px;margin-top:15px">
              <template slot="prepend">彩盒长</template>
            </el-input>
            <el-input placeholder="请输入内容" v-model="input2" style="width:300px;margin-left:40px">
              <template slot="prepend">彩盒宽</template>
            </el-input>
            <el-input placeholder="请输入内容" v-model="input2" style="width:300px;margin-left:40px">
              <template slot="prepend">彩盒高</template>
            </el-input>
            <el-input placeholder="请输入内容" v-model="input2" style="width:300px;margin-top:15px">
