  ...
  <div class="salesForecast">
    ...
    <div class="title">
      ...
      <div class="title_right">
        <el-button type="primary" @click="salesProducts">添加销量预估产品</el-button>
        <el-button type="primary" @click="historicalSales">查看历史销量</el-button>
      </div>
    </div>
    <!-- 表格 -->
    <div class="content">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="操作" align="center" width="240">
          <template>
            <el-button type="success" size="mini" @click="newSalesProjections">新的销量预估</el-button>
            <el-button type="primary" size="mini" @click="procurementDemand">生成采购需求</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <!-- 添加销量预估产品弹窗 -->
    <el-dialog title="提示" :visible.sync="salesProductsPop" width="40%">
      <div class="title">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="salesProductsPop = false">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 查看历史销量弹窗 -->
    <el-dialog title="历史销量" :visible.sync="historicalSalesPop" width="40%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="historicalSalesPop = false">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 新的销量预估弹窗 -->
    <el-dialog title="提示" :visible.sync="newSalesProjectionsPop" width="50%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="newSalesProjectionsPop = false">确 定</el-button>
      </span>
    </el-dialog>
    <!-- 生成采购需求 -->
