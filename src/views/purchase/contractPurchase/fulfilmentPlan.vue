  ...
  <div class="fulfilmentPlan">
    ...
    <div class="title">
      <div class="title_left">
        ...
        <el-select v-model="value" placeholder="请选择部门查询" style="margin-left:20px">
          <el-option v-for="item in state" :key="item.id" :label="item.label" :value="item"></el-option>
        </el-select>
        <el-select v-model="value" placeholder="请选择审核状态查询" style="margin-left:20px">
          <el-option v-for="item in state" :key="item.id" :label="item.label" :value="item"></el-option>
        </el-select>
        <el-input placeholder="请输入编号查询" style="width:210px;margin-left:20px"></el-input>
    ...
    <div class="content">
      <el-table :data="tableData" border style="width: 100%" @expand-change="clickDetails">
        ...
        <el-table-column label="操作" align="center" width="240">
          <template>
            <el-button size="mini" type="success" @click="deleteDemand">详情</el-button>
            <el-button size="mini" type="primary" @click="dismissDemand">出货计划</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <!-- 删除需求弹窗 -->
    <el-dialog title="提示" :visible.sync="deleteDemandPop" width="60%">
