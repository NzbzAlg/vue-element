    ...
    <div class="content">
      <el-table :data="tableData" border style="width: 100%" @expand-change="clickDetails">
        <el-table-column label="查看商品" type="expand">
          <template>
            ...
            <el-table :data="tableData" border>
              ...
              <el-table-column prop="specsType" label="箱数" align="center"></el-table-column>
            </el-table>
          </template>
        </el-table-column>
        <el-table-column prop="date" label="关联编号" align="center"></el-table-column>
        <el-table-column prop="date" label="创建部门" align="center"></el-table-column>
        ...
        <el-table-column label="操作" align="center" width="200">
          <template>
            <el-button size="mini" type="success" @click="salesForecast">销量预估</el-button>
