  ...
  <div class="purchaseSummary">
    ...
    <div class="title">
      <div class="title_left">
        ...
        ></el-date-picker>
        <el-select v-model="value" placeholder="请选择供应商查询" filterable style="margin-left:20px">
    ...
    <div class="content">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="date" label="供应商名称" align="center"></el-table-column>
        <el-table-column prop="name" label="采购总数量" align="center"></el-table-column>
        <el-table-column prop="address" label="采购总金额" align="center"></el-table-column>
        <el-table-column prop="address" label="入库总数量" align="center"></el-table-column>
        <el-table-column prop="address" label="未入库数量" align="center"></el-table-column>
        <el-table-column prop="address" label="未入库金额" align="center"></el-table-column>
        <el-table-column prop="address" label="弃置数" align="center"></el-table-column>
        <el-table-column prop="address" label="弃置金额" align="center"></el-table-column>
        <el-table-column prop="address" label="采购订单单数" align="center"></el-table-column>
      </el-table>
    </div>
    <!-- 生成采购需求 -->
    <el-dialog title="提示" :visible.sync="procurementDemandPop" width="50%">
        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          ...
          <el-tab-pane label="采购需求" name="demand">
            <el-table :data="tableData" border style="width: 100%">
              ...
              <el-table-column prop="name" label="下单数量" align="center"></el-table-column>
              <el-table-column prop="name" label="装箱数(个)" align="center"></el-table-column>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="procurementDemandPop = false">确 定</el-button>
      </span>
    </el-dialog>
