<template>
  <div class="pleaseDownload">
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column label="操作" align="center" width="100">
          <template>
            <el-button size="mini" type="primary" @click="refund"
              >返款</el-button
            >
          </template>
        </el-table-column>
    ...
    <!-- 返款弹窗 -->
    <el-dialog title="编辑" :visible.sync="refundPop" width="30%">
      <el-form :model="form" label-width="90px">
        <el-form-item label="返款地址：">
          <el-select
            v-model="value"
            placeholder="请选择返款地址"
            style="width: 100%"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="refundPop = false">取 消</el-button>
        <el-button type="primary" @click="refundPop = false">确 定</el-button>
      </div>
    </el-dialog>
    <!-- 分页 -->
    <div class="paging">
