...
<template>
  <div class="outboundOrder">
    ...
    <!-- 详情弹窗 -->
    <el-dialog title="出库单详情" :visible.sync="detailListPop" width="60%">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="address" label="采购单价(￥)" align="center">
        </el-table-column>
        <el-table-column prop="address" label="单位费用(￥)" align="center">
        </el-table-column>
        <el-table-column prop="address" label="单位入库成本(￥)" align="center">
        </el-table-column>
        <el-table-column prop="address" label="良品量" align="center">
        </el-table-column>
        <el-table-column prop="address" label="次品量" align="center">
        </el-table-column>
        <el-table-column prop="address" label="待检量" align="center">
        </el-table-column>
        <el-table-column prop="address" label="货值" align="center">
        </el-table-column>
        <el-table-column prop="address" label="费用" align="center">
        </el-table-column>
    ...
    <!-- 添加成本补录单弹窗 -->
    <el-dialog title="添加出库单" :visible.sync="addSupplementPop" width="60%">
