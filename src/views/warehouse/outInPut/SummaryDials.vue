...
<template>
  <div class="SummaryDials">
    ...
    <div class="table">
      <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <div class="tabItem">
            <p>
              <el-button type="primary" size="small" @click="addSupplement"
                >添加加工单</el-button
              >
              <el-button size="small" type="primary" @click="breakSingle"
                >添加拆分单</el-button
              >
            </p>
          </div>
        ...
        <el-tab-pane label="待配货" name="second">
          <div class="tabItem">
            <p>
              <el-button size="small">分配库存</el-button>
            </p>
          </div>
          <el-table :data="tableData" border style="width: 100%">
            <el-table-column label="详情" type="expand" width="50">
        ...
        <el-tab-pane label="待完成" name="third">
          <div class="tabItem">
            <p>
              <el-button size="small">完成加工</el-button>
              <el-button size="small">完成拆分</el-button>
            </p>
          </div>
          <el-table :data="tableData" border style="width: 100%">
            <el-table-column label="详情" type="expand" width="50">
    ...
    <!-- 详情弹窗 -->
    <el-dialog title="加工单详情" :visible.sync="detailListPop" width="60%">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="组合FNSKU" align="center">
        </el-table-column>
        <el-table-column prop="address" label="加工量" align="center">
        </el-table-column>
        <el-table-column prop="address" label="单品品名/SKU" align="center">
        </el-table-column>
        <el-table-column prop="address" label="FNSKU" align="center">
        </el-table-column>
        <el-table-column prop="address" label="数量" align="center">
        </el-table-column>
        <el-table-column prop="address" label="单品加工量" align="center">
        </el-table-column>
        <el-table-column prop="address" label="库存可用量" align="center">
        </el-table-column>
      </el-table>
    ...
    <!-- 添加加工单弹窗 -->
    <el-dialog title="添加加工单" :visible.sync="addSupplementPop" width="60%">
      <div class="addSupplement">
        ...
        <div class="addSupplement_content">
          ...
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="address" label="组合FNSKU" align="center">
            </el-table-column>
            <el-table-column prop="address" label="加工量" align="center">
            </el-table-column>
            <el-table-column prop="address" label="单品品名/SKU" align="center">
    ...
    <!-- 添加拆分单弹窗 -->
    <el-dialog title="添加拆分单" :visible.sync="breakSinglePop" width="60%">
      <div class="addSupplement">
        <div class="addSupplement_title">
          <el-form label-width="50px">
            <el-col :span="8">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="breakSinglePop = false">取 消</el-button>
        <el-button type="primary" @click="breakSinglePop = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default {
  data() {
    return {
      ...
      addSupplementPop: false, //添加加工单弹窗
      breakSinglePop: false, //添加拆分单弹窗
