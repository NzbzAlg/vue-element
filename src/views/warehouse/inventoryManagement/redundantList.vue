...
<template>
  <div class="redundantList">
    ...
    <div class="table">
      <div class="tabItem">
        <p class="redundantWarning">
          <i class="el-icon-message-solid"></i>
          当前<span style="color: #409eff; padding: 0 5px">0</span
          >家店铺达到冗余预警线
        </p>
        <div>
          <p>
      ...
      >
        ...
        <el-table-column label="成本预估" align="center">
          <el-table-column
            label="高库龄成本"
            align="center"
            width="100"
        ...
        <el-table-column label="仓库概况" align="center">
          ...
          <el-table-column label="高库龄数" align="center" sortable width="110">
            <template slot-scope="scope">
              {{ scope.row.daysAvailable }}天
            </template>
          </el-table-column>
          <el-table-column label="高库龄数仓储费 " align="center" sortable>
            <template slot-scope="scope">
        ...
        <el-table-column label="库龄状况" align="center">
          <el-table-column
        ...
        <el-table-column label="LTSF预计" align="center">
          <el-table-column
            prop="yesterdayReturn"
            label="预计总LTSF"
            align="center"
