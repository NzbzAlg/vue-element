...
<template>
  <div class="InventoryList">
    ...
    <div class="table">
      <p class="tabItem">
        <span @click="msg = 1" :class="{ tab_active: msg === 1 }">父ASIN</span>
        <span @click="msg = 2" :class="{ tab_active: msg === 2 }">子ASIN</span>
      </p>
      <el-table
        :data="tableData"
        style="width: 100%"
      ...
      >
        ...
        <el-table-column prop="SKU" label="SKU" align="center" width="155">
        </el-table-column>
        <el-table-column
          prop="SKU"
          label="设置详情(天)"
          ...
          <template slot-scope="scope">
            <p>
              到货：<input
                ...
                v-model="scope.row.AOG"
              />
            </p>
            <p style="margin-top: 5px">
              备货：<input
                style="width: 50px; height: 20px"
                v-model="scope.row.stockUp"
              />
            </p>
          </template>
        </el-table-column>
        <el-table-column label="智能补货" align="center">
          ...
          <el-table-column label="可售天数" align="center">
            <template slot-scope="scope">
              {{ scope.row.daysAvailable }}天
            </template>
          </el-table-column>
          <el-table-column label="建议补货数量" align="center">
            <template slot-scope="scope">
              {{ scope.row.suggestedQuantity }}
            </template>
          </el-table-column>
          <el-table-column label="建议补货时间" align="center">
            <template slot-scope="scope">
        ...
        <el-table-column label="退货量情况" align="center">
          <el-table-column
            prop="yesterdayReturn"
            label="昨日退货量"
            align="center"
          ></el-table-column>
          <el-table-column
          ...
          ></el-table-column>
          <el-table-column
            prop="fourteendayReturn"
            label="14日退货量"
            align="center"
          ></el-table-column>
          <el-table-column
            prop="thirtydayReturn"
            label="30日退货量"
            align="center"
          ></el-table-column>
          <el-table-column
